                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Nama Penerima"
                                                    required="required" v-model="invForm.recipient_name">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Kota"
                                                    required="required" v-model="invForm.recipient_city">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <table class="table table-bordered table-hover" style="width: 100%">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td class="text-center font-weight-bold"
                                                        v-if="['1','2'].includes(invForm.invoice_type)">
                                                        @{{ invForm.total_volume ? parseFloat(invForm.total_volume).toFixed(2) : 0 }}</td>
                                                    </td>
                                                    {{-- m3 --}}
                                                    <td class="text-center font-weight-bold">
                                                        @{{ invForm.total_volume_m3 ? parseFloat(invForm.total_volume_m3).toFixed(2) : 0 }}
                                                    </td>
                                                    {{-- actual --}}
                                                    <td class="text-center font-weight-bold">
        ...
        new Vue({
            ...
            mounted() {
                this.invForm = {
                    ...
                    destination_id: this.manifest.destination_id,
                    vendor_name: this.manifest.vendor_name,
                    vendor_type: this.manifest.vendor_type,
