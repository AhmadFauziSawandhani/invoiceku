                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <v-select :taggable="true" required="required" autocomplete
                                                    :selectOnTab="true" placeholder="Nama Pengirim"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <v-select required="required" autocomplete :selectOnTab="true"
                                                    placeholder="Cari Kecamatan" style="text-transform:uppercase"
                                                    :options="destinations" @option:selected="onSelectDestination" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" v-model="invForm.drop_pickup"
                                                    required="required" placeholder="Supir">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select v-model="invForm.service_type" id="service_type"
                                                    class="form-control">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" v-model="invForm.do_number"
                                                    placeholder="Supir">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="file" required="required" class="form-control"
                                                    @change="onChangeFotoProduct" placeholder="Foto Produk">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" required="required"
                                                    placeholder="Nama Penerima" v-model="invForm.recipient_name">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Kota</label>
                                                <input type="text" class="form-control" required="required"
                                                    placeholder="Kota" v-model="invForm.recipient_city">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Alamat</label>
                                                <textarea class="form-control" required="required" placeholder="Alamat" v-model="invForm.recipient_address"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-hover" style="width: 100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" rowspan="2" style="vertical-align: middle;"
                                                        class="text-center">
                                                        Volume @{{ invForm.invoice_type == '3' ? '(Udara/Kg)' : '(Darat Laut)' }}</th>
                                                    <th scope="col" rowspan="2" style="vertical-align: middle;"
                                                        class="text-center"
                                                    ...
                                                    <th scope="col" rowspan="2" style="vertical-align: middle;"
                                                        ...
                                                        Actual</th>
                                                    <th scope="col" rowspan="2" style="vertical-align: middle;"
                                                        class="text-center">Chargeable Weight
                                                    </th>
                                                    <th scope="col" rowspan="2" style="vertical-align: middle;"
                                            ...
                                            <tbody>
                                                <tr v-for="(item, index) in invForm.details">
                                                    ...
                                                    <td style="min-width:110px;"><input type="text"
                                                            required="required" id="price" disabled
                                                    ...
                                                    <td style="min-width:110px;"
                                                        v-if="['1','2'].includes(invForm.invoice_type)"><input
                                                            type="text" id="volume_m3" class="form-control volume_m3"
                                                            disabled v-model="invForm.details[index].volume_m3"
        ...
        new Vue({
            ...
            methods: {
                ...
                calculateVolume(p, l, t, colly) {
                    let volCal = this.invForm.invoice_type == '3' ? 5000 : 4000
                ...
                calculatePackaging(index) {
                    switch (this.invForm.details[index].packaging) {
                        case 'PAKING KAYU':
                            this.invForm.details[index].charge_packaging = (this.invForm.details[index]
                                .dimension_p *
                                this.invForm.details[index].dimension_l * this.invForm.details[index]
                                .dimension_t *
                                0.6).toFixed() * this.invForm.details[index].colly
                            break;
                        case 'WRAPPING':
                            this.invForm.details[index].charge_packaging = (this.invForm.details[index]
                                .dimension_p *
                                this.invForm.details[index].dimension_l * this.invForm.details[index]
                                .dimension_t *
                                0.2).toFixed() * this.invForm.details[index].colly
                            break;
                        case 'DUS + WRAPPING':
                            this.invForm.details[index].charge_packaging = (this.invForm.details[index]
                                .dimension_p *
                                this.invForm.details[index].dimension_l * this.invForm.details[index]
                                .dimension_t *
                                0.3).toFixed() * this.invForm.details[index].colly
                            break;
                        ...
                        case 'KARUNG':
                            this.invForm.details[index].charge_packaging = (this.invForm.details[index]
                                ...
                                0.3).toFixed() * this.invForm.details[index].colly
                            break;
                        case 'KARUNG + WRAPPING':
                            this.invForm.details[index].charge_packaging = (this.invForm.details[index]
                                .dimension_p *
                                this.invForm.details[index].dimension_l * this.invForm.details[index]
                                .dimension_t *
                                0.4).toFixed() * this.invForm.details[index].colly
                            break;
                        case 'KARUNG + PACKING KAYU':
                            this.invForm.details[index].charge_packaging = (this.invForm.details[index]
                                .dimension_p *
                                this.invForm.details[index].dimension_l * this.invForm.details[index]
                                .dimension_t *
                                1.2).toFixed() * this.invForm.details[index].colly
                            break;
                        default:
                ...
                async fetchDestination() {
                    const url = "{{ route('get-destination') }}"
                    await axios.get(url).then((resp) => {
                        if (resp.data.length > 0) {
                            resp.data.forEach((val) => {
                                this.destinations.push({
                                    label: `${val.name} - ${val.regency.name}`,
                                    value: {
                                        id: val.id,
                                        name: val.regency.name,
                                    }
                                })
                            })
                        }
                ...
                onSelectDestination(input) {
                    if (input.value) {
                        this.invForm.destination_id = input.value.id
                        this.invForm.destination = input.value.name
                        this.invForm.recipient_city = input.value.name
                    }
                },
                onSubmitForm() {
