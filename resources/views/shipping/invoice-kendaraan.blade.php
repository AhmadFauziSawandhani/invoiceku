            ...
            <table autosize="1"
                ...
                <thead>
                    <tr style="font-weight: bold;">
                        ...
                        <th class="border-td text-md" style="width: 10%;">Unit</th>
                        <th class="border-td text-md" style="width: 10%;">PRODUCT</th>
                ...
                <tbody style="font-size: 15pt;">
                    @foreach ($details as $key => $item)
                        <tr>
                            <td class="text-center text-md border-left" style="width: 3%;">{{ $key + 1 }}</td>
                            ...
                            <td class="text-center text-md" style="width: 10%;">{{ $item->unit }}</td>
                            <td class="text-center text-md" style="width: 10%;">{{ $item->product }}</td>
                            <td class="text-center text-md" style="width: 10%;">
                    ...
                    @if ($row <= 5)
                        <tr>
                            <td colspan='14' class='border-left border-right' style='line-height: 15px;'>
                                &nbsp;
                            </td>
                        </tr>
                    @endif
                    ...
                    @else
                        @foreach ($images as $image)
                            <tr>
                                <td colspan="14" class="border-left border-right">
                                    @php
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="14" style="line-height: 24px;">&nbsp;</td>
                    </tr>
                    <tr>
                        <td class="border-td" colspan="2" style="font-size: 15pt;line-height: 32px;width: 15%;">
                            Inword</td>
